...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      home: MyHomePage(title: 'GF BUTTONS'),
    );
  }
}
...
class _MyHomePageState extends State<MyHomePage> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        backgroundColor: getGFColor(GFColor.white),

        title: Text(widget.title, style: TextStyle(fontSize: 16, color: getGFColor(GFColor.dark)),),
      ),
//      body:
//
