    ...
    return Scaffold(
      ...
      body: GFIntroScreen(
        ...
        introScreenBottomNavigationBar: GFIntroScreenBottomNavigationBar(
          ...
          // onForwardButtonTap: () { print('forward'); },
          // onBackButtonTap: () { print('back'); },
          // onDoneTap: (){ print('done'); },
          // onSkipTap: (){ print('skip'); },
          ...
          // backButton: const GFButton(onPressed: null, child: Text('return'),),
          // forwardButton: const GFButton(onPressed: null, child: Text('go'),),
          // skipButton: const GFButton(onPressed: null, child: Text('jump'),),
          // doneButton: const GFButton(onPressed: null, child: Text('ok'),),

          // backButtonText: 'return',
          // forwardButtonText: 'go',
          // skipButtonText: 'jump',
          // doneButtonText: 'ok',
          //
      ...
      //   bottomNavigationBar: GFIntroScreenBottomNavigationBar(
      //   pageController: _pageController,
      // pageCount: slide.length,
      // currentIndex: initialPage,
      //   ),
...
//    );
          ...
          child: Column(
            ...
            children: <Widget>[
              ...
              //     contentChild: const Icon(Icons.umbrella),
              //     child: const Text('Get Widget')),
//            GFAccordion(
//              titleChild: Text('fgk'),
...
//            ),
              ...
              GFRating(
                ...
                // size: 55,
                // defaultIcon: const Icon(Icons.favorite_border, size: 55,),
                // filledIcon: const Icon(Icons.favorite, size: 55,),
...
//            ),
              ...
              GFTabBarView(
                  ...
                  controller: tabController,
                  children:
                      tabList.map((text) => Container(child: text)).toList()),
//
//            GFItemsCarousel(
//              rowCount: 6,
////              itemHeight: 600,
