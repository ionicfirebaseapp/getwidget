...
void main() {
  testWidgets('GFStickyHeader without direction, content and stickyContent',
      (tester) async {
    // `GFStickyHeader.direction` null, `GFStickyHeader.content` null, `GFStickyHeader.stickyContent` null
    expect(
      () => GFStickyHeader(
        content: null,
        stickyContent: null,
