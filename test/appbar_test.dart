...
void main() {
  ...
  testWidgets('GFAppBar with null values', (tester) async {
    // `GFAppBar.automaticallyImplyLeading` null or `GFAppBar.elevation` null
    // or `GFAppBar.titleSpacing` null or `GFAppBar.toolbarOpacity` null or `GFAppBar.bottomOpacity` null.
    expect(
      () => GFAppBar(
