...
class _AlertsState extends State<Alerts> with TickerProviderStateMixin {
  ...
  Widget build(BuildContext context) {
    return Stack(
      children: <Widget>[
        Container(
          height: widget.containerheight!=null? widget.containerheight: MediaQuery.of(context).size.height,
          color: widget.containerbackgroundColor !=null? widget.containerbackgroundColor: Colors.black38,
        ),
       Positioned(
    top:
