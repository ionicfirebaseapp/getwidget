...
class GFRadioButton extends StatefulWidget {
  const GFRadioButton({
    ...
    this.inactiveIcon = const Icon(Icons.close, size: 20, color: GFColors.DARK,),
...
//
  ...
  Widget build(BuildContext context) => InkWell(
    ...
    child: Container(
      ...
      child: isSelected
          ? widget.type == GFRadioButtonType.basic || widget.type == GFRadioButtonType.square
      ?Stack(
        children: <Widget>[
          Container(
          ...
          :widget.type == GFRadioButtonType.blunt? Stack(
        children: <Widget>[
          Container(
            alignment: Alignment.center,
          ),
          ...
          :widget.type ==GFRadioButtonType.custom ? widget.activeIcon : widget.inactiveIcon: widget.inactiveIcon
    )
  );
}
